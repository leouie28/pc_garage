...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getProduct: function getProduct() {
      ...
      axios.get("/admin-api/order/get-product").then(function (_ref) {
        var data = _ref.data;
    ...
    getCustomer: function getCustomer() {
      ...
      this.customers.forEach(function (elem) {
        _this3.customers.push;
      });
    },
    save: function save() {
  ...
  watch: {
    raw: function raw(val) {
      ...
      this.products.forEach(function (elem) {
        if (elem.id == val) {
          _this4.mx = parseInt(elem.stocks_sum_stocksstocks);
        }
      });
      this.compute(val);
    },
