  ...
  _draw() {
    ...
    const drawLegendBox = function(x, y, legendItem) {
      ...
      if (labelOpts.usePointStyle) {
        ...
        Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aC"])(ctx, drawOptions, centerX, centerY, boxWidth);
      } else {
...
class Tooltip extends Element {
  ...
  _drawColorBox(ctx, pt, i, rtlHelper, options) {
    ...
    if (options.usePointStyle) {
      ...
      ctx.lineWidth = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["i"])(labelColors.borderWidth) ? Math.max(...Object.values(labelColors.borderWidth)) : (labelColors.borderWidth || 1);
      ctx.strokeStyle = labelColors.borderColor;
...
var plugin_tooltip = {
  ...
  defaults: {
    ...
    callbacks: {
      beforeTitle: _chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aD"],
      title(tooltipItems) {
      ...
      afterTitle: _chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aD"],
      beforeBody: _chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aD"],
      beforeLabel: _chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aD"],
      label(tooltipItem) {
        if (this && this.options && this.options.mode === 'dataset') {
      ...
      afterLabel: _chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aD"],
      afterBody: _chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aD"],
      beforeFooter: _chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aD"],
      footer: _chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aD"],
      afterFooter: _chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aD"]
    }
  },
  defaultRoutes: {
    bodyFont: 'font',
...
function generateTicks$1(generationOptions, dataRange) {
  ...
  let spacing = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aG"])((rmax - rmin) / maxSpaces / unit) * unit;
  ...
  if (numSpaces > maxSpaces) {
    spacing = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aG"])(numSpaces * spacing / maxSpaces / unit) * unit;
  }
  ...
  if (minDefined && maxDefined && step && Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aH"])((max - min) / step, spacing / 1000)) {
    ...
    if (Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aI"])(numSpaces, Math.round(numSpaces), spacing / 1000)) {
  ...
  const decimalPlaces = Math.max(
    Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aJ"])(spacing),
    Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aJ"])(niceMin)
  );
  ...
  if (minDefined) {
    if (includeBounds && niceMin !== min) {
      ...
      if (Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aI"])(Math.round((niceMin + j * spacing) * factor) / factor, min, relativeLabelSize(min, minSpacing, generationOptions))) {
        j++;
      }
    } else if (niceMin < min) {
      j++;
  ...
  if (maxDefined && includeBounds && niceMax !== max) {
    if (ticks.length && Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aI"])(ticks[ticks.length - 1].value, max, relativeLabelSize(max, minSpacing, generationOptions))) {
...
class LinearScaleBase extends Scale {
  ...
  buildTicks() {
    ...
    if (opts.bounds === 'ticks') {
      Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aF"])(ticks, this, 'value');
    }
    if (opts.reverse) {
      ticks.reverse();
      this.start = this.max;
...
function measureLabelSize(ctx, font, label) {
  ...
  return {
    w: Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aK"])(ctx, font.string, label),
...
function addTick(ticks, time, timestamps) {
  if (!timestamps) {
    ...
    const {lo, hi} = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aM"])(timestamps, time);
...
class TimeScale extends Scale {
  ...
  buildTicks() {
    ...
    const min = this.min;
    const max = this.max;
    const ticks = Object(_chunks_helpers_segment_js__WEBPACK_IMPORTED_MODULE_0__["aL"])(timestamps, min, max);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a$", function() { return RAD_PER_DEG; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aC", function() { return drawPointLegend; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aD", function() { return noop; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aE", function() { return distanceBetweenPoints; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aF", function() { return _setMinAndMaxByKey; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aG", function() { return niceNum; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aH", function() { return almostWhole; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aI", function() { return almostEquals; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aJ", function() { return _decimalPlaces; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aK", function() { return _longestText; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aL", function() { return _filterBetween; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aM", function() { return _lookup; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aN", function() { return isPatternOrGradient; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aO", function() { return getHoverColor; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aP", function() { return clone$1; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aQ", function() { return _merger; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aR", function() { return _mergerIf; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aS", function() { return _deprecated; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aT", function() { return toFontString; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aU", function() { return splineCurve; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aV", function() { return splineCurveMonotone; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aW", function() { return getStyle; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aX", function() { return fontString; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aY", function() { return toLineHeight; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "aZ", function() { return PITAU; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a_", function() { return INFINITY; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b0", function() { return QUARTER_PI; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b1", function() { return TWO_THIRDS_PI; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b2", function() { return _angleDiff; });
